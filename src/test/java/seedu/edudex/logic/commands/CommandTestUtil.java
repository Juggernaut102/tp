...
public class CommandTestUtil {
    ...
    public static final String VALID_SCHOOL_AMY = "amy@example.com";
    public static final String VALID_SCHOOL_BOB = "bob@example.com";
    ...
    public static final String INVALID_SCHOOL_DESC = " " + PREFIX_SCHOOL + "bob!yahoo"; // missing '@' symbol
