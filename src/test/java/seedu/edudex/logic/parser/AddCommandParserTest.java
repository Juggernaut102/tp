...
import static seedu.edudex.logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static seedu.edudex.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static seedu.edudex.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
...
public class AddCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + SUBJECT_DESC_BOB, Email.MESSAGE_CONSTRAINTS);
