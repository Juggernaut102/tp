...
public class AddCommandParserTest {
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        // invalid school
        assertParseFailure(parser, INVALID_SCHOOL_DESC + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_SCHOOL));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, NAME_DESC_BOB + VALID_PHONE_BOB + SCHOOL_DESC_BOB + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing school prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + VALID_SCHOOL_BOB + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing address prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB + VALID_ADDRESS_BOB,
                expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid school
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_SCHOOL_DESC + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + SUBJECT_DESC_BOB, School.MESSAGE_CONSTRAINTS);
