...
public class CommandTestUtil {
    ...
    public static final String TIME_DESC_AMY = " " + PREFIX_DAY + VALID_DAY_AMY + PREFIX_START + VALID_STARTTIME_AMY
            + PREFIX_END + VALID_ENDTIME_AMY;
    public static final String TIME_DESC_BOB = " " + PREFIX_DAY + VALID_DAY_BOB + PREFIX_START + VALID_STARTTIME_BOB
            + PREFIX_END + VALID_ENDTIME_BOB;
