...
public class MainWindow extends UiPart<Stage> {
    ...
    private static final String ADD_STARTING_SUBJECT_MESSAGE = "Welcome to EduDex! Please start by adding the subjects you teach.\n"
    ...
    // Temporary StackPane for Subject testing
    @FXML
    private StackPane subjectListPanelPlaceholder;
    ...
    void fillInnerParts() {
        ...
        SubjectListPanel subjectListPanel = new SubjectListPanel(logic.getSubjectList());
        subjectListPanelPlaceholder.getChildren().add(subjectListPanel.getRoot());

        resultDisplay = new ResultDisplay();
        resultDisplayPlaceholder.getChildren().add(resultDisplay.getRoot());

        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getEduDexFilePath());
     ...
     *
     * @see seedu.edudex.logic.Logic#execute(String)
     */
